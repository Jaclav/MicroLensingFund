...
os.mkdir("../" + sys.argv[1] + "/xallarap_final_2")
os.mkdir("../" + sys.argv[1] + "/xallarap_final_2/png")
...
for i, file in enumerate(xallarapName):
    ...
    with open(f"../{sys.argv[1]}/xallarap_final/{file}.OUT", "r") as fileOUT:
        print(fileOUT.name)
    ...
    yamlN = "../" + sys.argv[1] + "/xallarap_final_2/" + file + ".yaml"
    yamlN = open(yamlN, "w+")
    graphicF = sys.argv[1] + "/xallarap_final_2/png/" + file
    YAML = [
        "photometry_files:",
